    ...
    <v-container>
        <v-layout column>
            ...
            <v-flex>
                ...
                <p class="subheading mt-3">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Eos ratione quisquam cupiditate, consequatur quis similique sequi iure cum inventore deserunt consequuntur odio autem ipsum.</p>
            </v-flex>
